//This C program creates a singly linked list and 
//finds its middle element using recursion with two pointers.
#include<stdio.h>
#include<malloc.h>
typedef struct node{
int data;
...
printf("The mid value : %d",MID(l1,l1));
return 0;
}
